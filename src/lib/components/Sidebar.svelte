...
<aside class="w-[72px] bg-dark-950 flex flex-col items-center py-3 gap-2 shrink-0 h-full">
	<!-- Home/DM button -->
	<button
	...
	<a
		href="/settings"
		class="w-12 h-12 rounded-[24px] bg-dark-700 hover:bg-purple-600 hover:rounded-[16px]
		       flex items-center justify-center transition-all duration-200 group"
		title="Settings"
	>
		<svg
			class="w-6 h-6 text-purple-400 group-hover:text-white transition-colors"
			fill="none"
			stroke="currentColor"
			viewBox="0 0 24 24"
		>
