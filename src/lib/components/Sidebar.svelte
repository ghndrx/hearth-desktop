<script lang="ts">
	import { currentServer, servers, type Server, isSettingsOpen } from '$lib/stores/app';
...
<aside class="w-[72px] bg-dark-950 flex flex-col items-center py-3 gap-2 shrink-0 h-screen">
	<!-- Home/DM button -->
	<button
	...
	<!-- Settings button -->
	<button
		class="w-12 h-12 rounded-[24px] bg-dark-700 hover:bg-gray-600 hover:rounded-[16px]
		       flex items-center justify-center transition-all duration-200 group mt-auto mb-3"
