...
{#if $isInVoice}
	<div class="voice-controls-bar">
		...
		<div class="control-buttons">
			...
			<!-- Deafen -->
			<Tooltip text={$voiceState.selfDeafened ? 'Undeafen' : 'Deafen'} shortcutId="toggle-deafen" position="top">
				<button
					class="control-btn"
			...
			<!-- Disconnect -->
			<Tooltip text="Disconnect" shortcutId="disconnect-voice" position="top">
				<button
