...
- [x] **T-HOTKEY-01**: Add `tauri-plugin-global-shortcut` and `rdev` crates for global input monitoring
- [x] **T-HOTKEY-02**: Implement cross-platform hotkey registration (Windows/macOS/Linux)
